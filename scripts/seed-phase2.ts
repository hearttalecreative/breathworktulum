...
async function run() {
    ...
    layout: [
      ...
      { blockType: "richText", heading: "One process. Two containers.", tone: "sand",
        body: lex(
          ...
          "The work moves through whatever you're carrying: core wounds, nervous system patterns, and inner child themes among them.") },
      { blockType: "list", heading: "Three things every Personalized Retreat has.", tone: "cream", width: "default",
        ...
        note: "Optional elements can be added when they serve the process: water-based breathwork, sound, Temazcal, and traditional Mayan ceremonies." },
      { blockType: "formatDetail", anchor: "formats", title: "3 Day Retreat in Riviera Maya", tagline: "The shortest immersive container with the full arc.", tone: "sand",
        ...
        investment: "From $18,000 MXN + 16% IVA.", cta: wa("Book a discovery call", "discoveryCall", "primary") },
      { blockType: "formatDetail", anchor: "five-day", title: "5 Day Immersive Retreat in Riviera Maya", tag: "Most chosen", tagline: "The format the method really opens up in.", tone: "cream",
        ...
        investment: "From $26,000 MXN + 16% IVA.", cta: wa("Book a discovery call", "discoveryCall", "primary") },
      { blockType: "formatDetail", anchor: "custom", title: "Custom In-Person Retreat", tagline: "Beyond the 3 and 5 day formats.", tone: "sand",
        ...
        investment: "Custom quotes after a discovery call.", cta: wa("Book a discovery call", "discoveryCall", "primary") },
      { blockType: "formatDetail", anchor: "virtual", title: "Virtual Personalized Retreat", tagline: "Real depth, no travel required.", tone: "cream",
        ...
        investment: "From $15,000 MXN for three sessions, $21,000 MXN for five. All prices + 16% IVA.", cta: wa("Book a discovery call", "discoveryCall", "primary") },
      ...
      { blockType: "list", heading: "The four steps to design your retreat.", tone: "sand",
        ...
        cta: { ...wa("Book a discovery call", "discoveryCall", "primary"), enabled: true } },
      ...
      { blockType: "ctaSection", heading: "Want to see if this is right for you?", width: "narrow", align: "center", tone: "cream",
        ...
        ctas: [wa("Book a discovery call", "discoveryCall", "primary"), wa("Message me on WhatsApp", "personalizedRetreat")] },
    ],
  });
  ...
  await page("work-with-me/group-practice", {
    ...
    metaDescription: "Two ways to experience Clarity Breathwork™ in a group setting. A weekly 1 Day Group Retreat in a national park, or a regular Group Session at Nomade in Tulum.",
    ogImage: palapa,
    layout: [
      { blockType: "hero", eyebrow: "Group Practice", heading: "Group practice. Two ways in.",
        lede: "A weekly 1 Day Group Retreat in a national park between Tulum and Playa del Carmen. And a regular Group Session at Nomade in Tulum. Same method, two containers, both booked ahead.",
      ...
      { blockType: "richText", heading: "Why this work changes in a group.", tone: "sand", width: "narrow",
        body: lex("Private sessions go deep one on one. Group sessions go wide. Different rhythm, different mirror.", "When people breathe together, the room becomes the work. Patterns you didn't know you carried surface in proximity to others moving through theirs.", "Many people who work with me do both. They start with a group session to feel the work, then book private. Or they start private and join the group for continuity.") },
      { blockType: "formatDetail", anchor: "one-day-retreat", title: "Breathe. Heal. Transform. 1 Day Group Retreat.", tag: "Weekly · Mid October to end of April", tagline: "A full day in a national park.", tone: "cream",
      ...
      { blockType: "formatDetail", anchor: "nomade", title: "Group Session at Nomade.", tag: "Regular · Tulum hotel zone", tagline: "The breathwork session, with a tight integration circle.", tone: "sand",
        body: lex("A regular group breathwork session held at Nomade in Tulum's hotel zone. Smaller container than the 1 Day Group Retreat, focused on the breathwork session itself with a tight integration circle after. Open to Nomade guests and to anyone who books ahead. A good way to experience the work without leaving the hotel zone. Around 2 hours. Message me for the next date."),
      ...
      { blockType: "ctaSection", heading: "Where group fits in the full work.", width: "default", align: "left", tone: "cream",
        body: "Both are scheduled group sessions. If after either one you want to go deeper, the next step is usually a Private Session or a Personalized Retreat.",
      ...
      { blockType: "faq", heading: "Questions, answered.", tone: "sand", items: [
        { question: "Can I drop in without booking ahead?", answer: "For the 1 Day Group Retreat in the national park, no. Tickets are on Eventbrite and dates fill ahead. For Nomade, message me first to confirm availability." },
        ...
        { question: "What should I bring?", answer: "For the 1 Day Group Retreat: comfortable clothes, water, swimsuit if relevant. Full details sent after booking. For Nomade: come as you are." },
      ...
      { blockType: "ctaSection", heading: "Find a date.", width: "narrow", align: "center", tone: "cream",
        ctas: [ext("See 1 Day Group Retreat dates on Eventbrite", EVENTBRITE), wa("Message me about Nomade", "general")] },
    ],
  });
  ...
  await page("work-with-me/curated-group-experiences", {
    ...
    layout: [
      ...
      { blockType: "richText", heading: "Where these experiences happen.", tone: "cream", width: "narrow",
        body: lex(
          "I work in Tulum, across the Riviera Maya, anywhere in Mexico, and internationally. Travel is part of what I offer, so the location can follow your group rather than the other way around.",
          "We can hold it at your villa, a retreat center, or a hotel, or in one of my own spaces: the deck in the national park, the jungle space near Playa, or Diamantek, my primary breathwork deck.") },
  ...
  await page("retreat-riviera-maya-2026", {
    ...
    layout: [
      ...
      { blockType: "ctaSection", heading: "Can't wait for the group retreat?", width: "narrow", align: "center", tone: "sand",
        body: "The dates are still forming. If you'd rather not wait, a Personalized Retreat gives you the same method on your own timeline, in person or online.",
        ctas: [link("Explore Personalized Retreats", "/work-with-me/personalized-retreats/"), link("Compare the two", "/work-with-me/personalized-retreats/#formats", "secondary")] },
