...
async function run() {
  ...
  await page("work-with-me/group-practice", {
    ...
    metaTitle: "Weekly Group Breathwork in a Tulum National Park",
    metaDescription: "Experience Clarity Breathwork™ in a group setting — a weekly 1 Day Group Retreat in a national park between Tulum and Playa del Carmen. Booked ahead.",
    ogImage: palapa,
    layout: [
      { blockType: "hero", eyebrow: "Group Practice", heading: "Group practice.",
        lede: "A weekly 1 Day Group Retreat in a national park between Tulum and Playa del Carmen. Booked ahead.",
        image: palapa, ctas: [ext("See dates on Eventbrite", EVENTBRITE), wa("Ask about group dates", "general", "secondary")] },
      ...
      { blockType: "ctaSection", heading: "Where group fits in the full work.", width: "default", align: "left", tone: "cream",
        body: "This is a scheduled group session. If afterwards you want to go deeper, the next step is usually a Private Session or a Personalized Retreat.",
      ...
      { blockType: "faq", heading: "Questions, answered.", tone: "sand", items: [
        { question: "Can I drop in without booking ahead?", answer: "For the 1 Day Group Retreat in the national park, no. Tickets are on Eventbrite and dates fill ahead." },
        { question: "Do I need breathwork experience?", answer: "No. It's open to first timers. The method is soft and trauma informed." },
        { question: "What should I bring?", answer: "For the 1 Day Group Retreat: comfortable clothes, water, and a swimsuit if relevant. Full details are sent after booking." },
      ...
      { blockType: "ctaSection", heading: "Find a date.", width: "narrow", align: "center", tone: "cream",
        ctas: [ext("See 1 Day Group Retreat dates on Eventbrite", EVENTBRITE), wa("Message me about group dates", "general")] },
    ],
  });
