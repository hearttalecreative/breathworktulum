...
async function run() {
  ...
  await page("work-with-me/personalized-retreats", {
    ...
    layout: [
      ...
      { blockType: "formatDetail", anchor: "custom", title: "Custom In-Person Retreat", tagline: "Beyond the 3 and 5 day formats.", tone: "sand",
        ...
        investment: "From $[price on inquiry]. Custom quotes after a discovery call.", cta: link("Book a discovery call", "/contact/") },
  ...
  await page("work-with-me/group-practice", {
    ...
    ogImage: palapa,
    layout: [
      { blockType: "hero", eyebrow: "Group Practice", heading: "Group practice. Two ways to drop in.",
        lede: "A weekly 1 Day Retreat in a national park between Tulum and Playa del Carmen. And a regular Group Session at Nomade in Tulum. Same method, two containers, both open to drop ins.",
      ...
      { blockType: "ctaSection", heading: "Drop in.", width: "narrow", align: "center", tone: "cream",
  ...
  await page("work-with-me/corporate", {
    ...
    layout: [
      ...
      { blockType: "richText", heading: "The technical backbone.", tone: "sand", width: "narrow",
        body: lex("The work is built on Clarity Breathwork™, a trauma informed technique I've practiced for over ten years, combined with somatic regulation and my three phase method, BREATHE.HEAL.TRANSFORM.®.", "The reason this works where other interventions don't: it's structured, body based, and doesn't ask anyone to adopt a belief system."),
  ...
  await page("retreat-riviera-maya-2026", {
    ...
    ogImage: riviera,
    layout: [
      { blockType: "hero", eyebrow: "Signature Event · Riviera Maya · 2026", heading: "Five days. Twenty people. One process. Riviera Maya, 2026.",
      ...
      { blockType: "list", heading: "First retreat: Q1 2026.", tone: "sand", intro: "The first edition is scheduled for Q1 2026. Specific dates are being finalized and will be shared with the waitlist first. Sign up below to get the dates before they go public, with priority access to apply for one of the twenty seats.",
        items: items("Five days, four nights.", "Location: ONZE Xpu Ha, Riviera Maya, Mexico.", "Group size: 11 to 20 participants.", "All meals included.", "Accommodation included.", "Investment: $[price on inquiry]. Payment plan available.") },
      ...
      { blockType: "richText", heading: "Investment.", tone: "sand", width: "narrow",
        body: lex("$[price on inquiry] per person. Includes accommodation, meals, all sessions, materials.", "Deposit is non-refundable to secure a seat. Balance is due in installments per a payment schedule sent at confirmation. Full terms in our retreat policies."),
      ...
      { blockType: "faq", heading: "Questions, answered.", tone: "sand", items: [
        { question: "When exactly is the first retreat?", answer: "First edition Q1 2026. Dates to be confirmed and shared with the waitlist first." },
